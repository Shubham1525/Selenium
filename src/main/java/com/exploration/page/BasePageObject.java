...
public class BasePageObject {
	...
	private void waitForList(ExpectedCondition<List<WebElement>> expectedCondition, Integer timeOutInSeconds) {
		timeOutInSeconds = timeOutInSeconds != null ? timeOutInSeconds : 30;
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOutInSeconds));
	...
	protected void waitForVisibilityOfAllElements(By locator, Integer... timeOutInSeconds) {
		waitForList(ExpectedConditions.visibilityOfAllElementsLocatedBy(locator),
				(timeOutInSeconds.length > 0 ? timeOutInSeconds[0] : null));	
	}
...
//				find(from), find(to));
	...
	protected void selectByIndex(By locator, int i) {
		Select objSelect = new Select(find(locator));
		objSelect.selectByIndex(i);
		log.info(objSelect.getFirstSelectedOption().getText());
	}
	...
	protected void selectByVisibleText(By locator, String visibleText) {
		Select objSelect = new Select(find(locator));
		objSelect.selectByValue(visibleText);
		log.info(objSelect.getFirstSelectedOption().getText());
	}
